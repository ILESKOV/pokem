...
contract PokemonBaseStatData is ERC1155, Ownable {
    ...
    uint256 public constant NIDORAN_MALE = 29;
    uint256 public constant NIDORINA = 30;
    uint256 public constant NIDOQUEEN = 31;
    uint256 public constant NIDORAN_FEMALE = 32;
    ...
    mapping(uint256 => PokemonBaseStats) private _pokemonNumberToPokemonBaseStats;
    ...
    function upgradePokemon(uint256 pokemonNumber) external {
        (uint256 whichMethodOfUpgrade, uint256 newPokemon) = checkAvailableUpgrade(pokemonNumber);
        if (whichMethodOfUpgrade < 14) {
            require(_stones.balanceOf(msg.sender, whichMethodOfUpgrade) > 0, "Thunder stone required");
            _stones.setApprovalForAll(address(this), true);
            _stones.burn(msg.sender, whichMethodOfUpgrade, 1);
            _mint(msg.sender, newPokemon, 1, "");
        } else if (whichMethodOfUpgrade == 14) {
            require(_level.balanceOf(msg.sender) >= _upgradeFee, "Level tokens required");
            _level.burn(_upgradeFee);
            _mint(msg.sender, pokemonNumber++, 1, "");
    ...
    function checkAvailableUpgrade(uint256 pokemonNumber) private view returns (uint256, uint256) {
        if (_thunderUpgrades[pokemonNumber] != 0) {
            return (0, _thunderUpgrades[pokemonNumber]);
        } else if (_moonUpgrades[pokemonNumber] != 0) {
            return (1, _moonUpgrades[pokemonNumber]);
        } else if (_fireUpgrades[pokemonNumber] != 0) {
            return (2, _fireUpgrades[pokemonNumber]);
        } else if (_leafUpgrades[pokemonNumber] != 0) {
            return (3, _leafUpgrades[pokemonNumber]);
        } else if (_sunUpgrades[pokemonNumber] != 0) {
            return (4, _sunUpgrades[pokemonNumber]);
        } else if (_waterUpgrades[pokemonNumber] != 0) {
            return (5, _waterUpgrades[pokemonNumber]);
        } else if (_blackAuguriteUpgrades[pokemonNumber] != 0) {
            return (6, _blackAuguriteUpgrades[pokemonNumber]);
        } else if (_shinyUpgrades[pokemonNumber] != 0) {
            return (7, _shinyUpgrades[pokemonNumber]);
        } else if (_duskUpgrades[pokemonNumber] != 0) {
            return (8, _duskUpgrades[pokemonNumber]);
        } else if (_razorClawUpgrades[pokemonNumber] != 0) {
            return (9, _razorClawUpgrades[pokemonNumber]);
        } else if (_peatBlockUpgrades[pokemonNumber] != 0) {
            return (10, _peatBlockUpgrades[pokemonNumber]);
        } else if (_tartAppleUpgrades[pokemonNumber] != 0) {
            return (11, _tartAppleUpgrades[pokemonNumber]);
        } else if (_crackedPotUpgrades[pokemonNumber] != 0) {
            return (12, _crackedPotUpgrades[pokemonNumber]);
        } else if (_ovalUpgrades[pokemonNumber] != 0) {
            return (13, _ovalUpgrades[pokemonNumber]);
        } else {
            if (true == _latestInEvolution[pokemonNumber]) {
                return (14, 0);
            } else return (15, 16);
        }
        // uint256 ice = _moonUpgrades[pokemonNumber];
        // uint256 sweetApple = _sweetAppleUpgrades[pokemonNumber];
    }
    ...
    constructor() ERC1155("ipfs://bafybeif66ywxdngsee6ltaxqzfwskezhusjdgwryw63z6sv2mi67nbccpe/") {
        ...
        _latestInEvolution[198] = true;
        _latestInEvolution[199] = true;

        _latestInEvolution[200] = true;
        ...
        _latestInEvolution[215] = true;
        _latestInEvolution[217] = true;
    ...
    function createBaseStatPokemon(
        ...
        PokemonBaseStats storage baseStats = _pokemonNumberToPokemonBaseStats[number];
        ...
        baseStats.specialAttack = specialAttack;
        baseStats.specialDefense = specialDefense;
        baseStats.speeed = speed;
    }
}
